...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('washTypeId', sa.String(), sa.ForeignKey('wash_types.id'), nullable=False),
    ...
    op.add_column('appointments', sa.Column('subscriptionId', sa.Integer(), sa.ForeignKey('subscriptions.id'), nullable=True))
