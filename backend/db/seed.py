        ...
        if res.scalar() == 0:
            services = [
                Service(
                    id="s4",
                    name="Обработка арок",
                    description="Глубокая очистка колесных арок с применением специализированного состава. Удаляет дорожный битум, стойкие загрязнения, тормозную пыль и реагенты.",
                    price=600,
                    durationMinutes=20,
                ...
                Service(
                    ...
                    description="Профессиональная очистка двигательного отсека от масла и грязи.",
                    price=1500,
                    durationMinutes=60,
                    category="Специальные услуги",
                    updatedAt=now,
                ...
                Service(
                    ...
                    description="Финальная полировка наружных стёкол для максимальной прозрачности и блеска.",
                    price=500,
                    durationMinutes=20,
                ...
                Service(
                    id="s7",
                    name="Антидождь",
                    description="Нанесение гидрофобного состава на стёкла, обеспечивающего отталкивание воды.",
                    price=600,
                    durationMinutes=25,
                    category="Обработка стёкол",
                    updatedAt=now,
                ...
                Service(
                    ...
                    description="Нанесение профессионального защитного воска на кузов для защиты ЛКП.",
                    price=1200,
                    durationMinutes=45,
                ...
                Service(
                    ...
                    description="Нанесение силантового покрытия для долговременной защиты кузова. Срок действия до 6 месяцев.",
                    price=2000,
                    durationMinutes=90,
                    category="Защитные покрытия",
                    updatedAt=now,
                ...
                Service(
                    ...
                    description="Профессиональное нанесение керамического покрытия. Максимальная защита ЛКП сроком до 2 лет.",
                    price=15000,
                    durationMinutes=480,
                    category="Защитные покрытия",
                    updatedAt=now,
                ...
                Service(
                    ...
                    description="Нанесение тефлонового покрытия для защиты кузова и стойкого блеска.",
                    price=3000,
                    durationMinutes=120,
                    category="Защитные покрытия",
                    updatedAt=now,
                ...
                Service(
                    ...
                    description="Профессиональное удаление следов битума, смолы, насекомых с кузова.",
                    price=700,
                    durationMinutes=30,
                    category="Специальные услуги",
                    updatedAt=now,
                ...
                Service(
                    id="s13",
                    name="Чернение шин",
                    description="Нанесение специального состава на боковины шин — восстанавливает чёрный цвет и глянцевый блеск.",
                    price=300,
                    durationMinutes=15,
                    category="Специальные услуги",
                    updatedAt=now,
                ...
                Service(
                    ...
                    description="Тщательная пылесосная обработка салона: сиденья, напольные покрытия, багажник.",
                    price=500,
                    durationMinutes=25,
                ...
                Service(
                    ...
                    description="Глубокая чистка тканевых и кожаных поверхностей профессиональной химией.",
                    price=3500,
                    durationMinutes=180,
                    category="Уход за салоном",
                    updatedAt=now,
                ...
                Service(
                    id="s16",
                    name="Химчистка кожи",
                    description="Специализированная очистка и кондиционирование кожаного салона.",
                    price=5000,
                    durationMinutes=240,
                    category="Уход за салоном",
                    updatedAt=now,
                ...
                Service(
                    id="s17",
                    name="Ароматизация",
                    description="Нанесение стойкого ароматизатора. Широкий выбор ароматов.",
                    price=300,
                    durationMinutes=15,
                    category="Уход за салоном",
                    updatedAt=now,
                ...
                Service(
                    id="s18",
                    name="Озонирование",
                    description="Обработка салона озоном для полного устранения запахов и дезинфекции.",
                    price=1000,
                    durationMinutes=60,
                    category="Уход за салоном",
                    updatedAt=now,
                ...
                Service(
                    ...
                    description="Полный комплекс детальной обработки: полировка кузова, нанесение защитного покрытия.",
                    price=8000,
                    durationMinutes=360,
                    category="Детейлинг",
                    updatedAt=now,
                ...
                Service(
                    ...
                    description="Машинная полировка ЛКП для устранения мелких царапин и восстановления блеска.",
                    price=5000,
                    durationMinutes=240,
                    category="Детейлинг",
                    updatedAt=now,
