                        ...
                        child: Column(
                          ...
                          TextFormField(
                            ...
                            decoration: AppStyles.inputDecoration('Логин',
                                hint: 'Введите логин', icon: Icons.person_outline),
  ...
  Widget build(BuildContext context) => Row(children: [
    ...
    Container(
      ...
      child: Text(login, style: const TextStyle(
          color: AppStyles.textPrimary, fontSize: 11,
          fontFamily: 'monospace', fontWeight: FontWeight.w600)),
    ),
    const Text(' / ', style: TextStyle(color: AppStyles.textMuted, fontSize: 12)),
    Container(
      padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
      decoration: BoxDecoration(
        color: AppStyles.bgMuted,
      ...
      child: Text(pass, style: const TextStyle(
          color: AppStyles.textPrimary, fontSize: 11,
          fontFamily: 'monospace', fontWeight: FontWeight.w600)),
    ),
  ]);
