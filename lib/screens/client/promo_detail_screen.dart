                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: const Text('СПЕЦПРЕДЛОЖЕНИЕ', style: TextStyle(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(promo.description, style: AppStyles.bodyLarge.copyWith(height: 1.6, color: AppStyles.textSecondary)),
                  const SizedBox(height: 32),
                  
                  Row(children: [
                    _InfoCard(Icons.access_time_rounded, '${promo.duration} мин'),
      ...
      bottomNavigationBar: Container(
        ...
        child: SafeArea(
          child: ElevatedButton(
            ...
            child: const Text('Записаться по акции', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
          ),
        ),
      ),
    );
