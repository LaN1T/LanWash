...
class DatabaseService {
  ...
  List<Map<String, dynamic>> _seedServices() => [
    ...
    {'id':'s4','name':'Мойка с активной пеной','description':'Мойка кузова с применением активной пены и профессиональной химии для стойких загрязнений.','price':1100,'durationMinutes':45,'category':'Мойка кузова','isFavorite':0,'isFromApi':0},
    {'id':'s5','name':'Очистка колёсных дисков','description':'Специализированная чистка дисков от тормозной пыли и нагара.','price':400,'durationMinutes':20,'category':'Мойка кузова','isFavorite':0,'isFromApi':0},
    {'id':'s6','name':'Мойка двигателя','description':'Профессиональная очистка двигательного отсека от масла и грязи.','price':1500,'durationMinutes':60,'category':'Мойка кузова','isFavorite':0,'isFromApi':0},
    {'id':'s7','name':'Полировка стёкол снаружи','description':'Финальная полировка наружных стёкол для максимальной прозрачности и блеска.','price':500,'durationMinutes':20,'category':'Обработка стёкол','isFavorite':0,'isFromApi':0},
    {'id':'s8','name':'Антидождь на стёкла','description':'Нанесение гидрофобного состава на стёкла, обеспечивающего отталкивание воды.','price':600,'durationMinutes':25,'category':'Обработка стёкол','isFavorite':0,'isFromApi':0},
    {'id':'s9','name':'Нанесение защитного воска','description':'Нанесение профессионального защитного воска на кузов для защиты ЛКП.','price':1200,'durationMinutes':45,'category':'Защитные покрытия','isFavorite':0,'isFromApi':0},
    {'id':'s10','name':'Нанесение силанта','description':'Нанесение силантового покрытия для долговременной защиты кузова. Срок действия до 6 месяцев.','price':2000,'durationMinutes':90,'category':'Защитные покрытия','isFavorite':0,'isFromApi':0},
    {'id':'s11','name':'Керамическое покрытие','description':'Профессиональное нанесение керамического покрытия. Максимальная защита ЛКП сроком до 2 лет.','price':15000,'durationMinutes':480,'category':'Защитные покрытия','isFavorite':0,'isFromApi':0},
    {'id':'s12','name':'Нанесение тефлона','description':'Нанесение тефлонового покрытия для защиты кузова и стойкого блеска.','price':3000,'durationMinutes':120,'category':'Защитные покрытия','isFavorite':0,'isFromApi':0},
    {'id':'s13','name':'Удаление битума и смол','description':'Профессиональное удаление следов битума, смолы, насекомых с кузова.','price':700,'durationMinutes':30,'category':'Специальные услуги','isFavorite':0,'isFromApi':0},
    {'id':'s14','name':'Чернение шин','description':'Нанесение специального состава на боковины шин — восстанавливает чёрный цвет и глянцевый блеск.','price':300,'durationMinutes':15,'category':'Специальные услуги','isFavorite':0,'isFromApi':0},
    {'id':'s15','name':'Пылесосная уборка салона','description':'Тщательная пылесосная обработка салона: сиденья, напольные покрытия, багажник.','price':500,'durationMinutes':25,'category':'Уход за салоном','isFavorite':0,'isFromApi':0},
    {'id':'s16','name':'Влажная уборка салона','description':'Обработка всех поверхностей салона специализированными средствами.','price':800,'durationMinutes':40,'category':'Уход за салоном','isFavorite':0,'isFromApi':0},
    {'id':'s17','name':'Химчистка салона','description':'Глубокая чистка тканевых и кожаных поверхностей профессиональной химией.','price':3500,'durationMinutes':180,'category':'Уход за салоном','isFavorite':0,'isFromApi':0},
    {'id':'s18','name':'Химчистка кожи','description':'Специализированная очистка и кондиционирование кожаного салона.','price':5000,'durationMinutes':240,'category':'Уход за салоном','isFavorite':0,'isFromApi':0},
    {'id':'s19','name':'Ароматизация салона','description':'Нанесение стойкого ароматизатора. Широкий выбор ароматов.','price':300,'durationMinutes':15,'category':'Уход за салоном','isFavorite':0,'isFromApi':0},
    {'id':'s20','name':'Озонирование салона','description':'Обработка салона озоном для полного устранения запахов и дезинфекции.','price':1000,'durationMinutes':60,'category':'Уход за салоном','isFavorite':0,'isFromApi':0},
    {'id':'s21','name':'Детейлинг кузова','description':'Полный комплекс детальной обработки: полировка кузова, нанесение защитного покрытия.','price':8000,'durationMinutes':360,'category':'Детейлинг','isFavorite':0,'isFromApi':0},
    {'id':'s22','name':'Полировка кузова','description':'Машинная полировка ЛКП для устранения мелких царапин и восстановления блеска.','price':5000,'durationMinutes':240,'category':'Детейлинг','isFavorite':0,'isFromApi':0},
  ];
}